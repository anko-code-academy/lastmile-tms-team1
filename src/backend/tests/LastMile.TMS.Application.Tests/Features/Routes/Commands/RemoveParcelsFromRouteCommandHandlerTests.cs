...
public class RemoveParcelsFromRouteCommandHandlerTests : IDisposable
{
    private readonly TestDbContext _context;
    private readonly IBinAssignmentService _binAssignmentService;
    private readonly RemoveParcelsFromRouteCommandHandler _sut;

    public RemoveParcelsFromRouteCommandHandlerTests()
    {
    ...
    [Fact]
    public async Task Handle_RemovedParcelsRevertToSortedAndGetBin()
    {
        // Arrange
    ...
    [Fact]
    public async Task Handle_NoBinAvailable_TransitionsToException()
    {
